...
<body>
	...
	<div class="container">
		<form  action="/application/courseList" method="GET">
			<div class="content">
				<div class="beforeApp">
					<h3 class="beforeTitle">💙 교육신청 전 확인사항</h3><br>
					<p>CUBe Academy <b>로그인 후</b>에 교육신청이 가능합니다. <b id="strong"> (회원가입제)</b><br></p>
				</div>
				<br><br>
				<div class="beforeApp">
					<h3 class="beforeTitle">💜 교육신청 방법</h3><br>
