            ...
            <nav class="sb-sidenav bg-info p-2 text-dark bg-opacity-25" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav" style="text-align: center;">
                    	...
                    	<a class="nav-link review" href="adminReviewList.do" style="color: #9966FF;"><div class="sb-nav-link-icon"><i class="fa fa-shoe-prints" aria-hidden="true"></i></div><span>Review</span></a>
                	</div>
            	</div>
        	</nav>
        </div>
		<div id="layoutSidenav_content">
			<main>
				...
				<div class="container-fluid px-4">
                    <h1 class="title_tab">수강 후기 관리</h1>
                    <br><br>
					<div class="card mb-4">
                        <div class="card-header"><i class="fas fa-table me-1"></i>수강 후기 목록</div>
						<div class="card-body">
								...
								<tbody>
									<c:forEach items="${qnaList}" var="dto">
			                            <tr>
			                                ...
			                                <td style="vertical-align:middle;">${dto.user_name}</td>
			                            	...
			                            	<td style="vertical-align:middle;">${dto.review_content}</td>
			                        	</tr>
			                    	</c:forEach>
                            	</tbody>
                            </table>
