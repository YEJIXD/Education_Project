                ...
                <nav class="sb-sidenav bg-info p-2 text-dark bg-opacity-25" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav" style="text-align: center;">
                            ...
                            <a class="nav-link faq" href="adminFaqList" style="color: #9966FF;"><div class="sb-nav-link-icon"><i class="fa fa-bars" aria-hidden="true"></i></div><span>F A Q</span></a>
                ...
                <main>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            	<form action="adminFaqInsert" method="POST">
	                                    ...
	                                    <tbody>
											<c:forEach items="${list}" var="dto">
				                            	<tr>
				                                    ...
				                                    <td style="vertical-align:middle;"><a href="faqDetail?faq_no=${dto.faq_no}" style="text-decoration:none; color:rgb(90, 197, 108); font-weight:bold;">${dto.faq_title}</a></td>
