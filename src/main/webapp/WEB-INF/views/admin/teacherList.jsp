        	...
        	<nav class="sb-sidenav bg-info p-2 text-dark bg-opacity-25" id="sidenavAccordion">
            	<div class="sb-sidenav-menu">
                	<div class="nav" style="text-align: center;">
                        ...
                        <a class="nav-link teacher" href="adminTeacherList.do" style="color: #9966FF;"><div class="sb-nav-link-icon"><i class="fa fa-graduation-cap" aria-hidden="true"></i></div><span>Teacher</span></a>
                                ...
                                <tbody>
									<c:forEach items="${teacherList}" var="dto">
			                        	<tr>
			                                ...
			                                <td style='vertical-align:middle;'><a onclick="return goUpdate();" href="adminTeacherUpdate.do?t_no=${dto.t_no}" style="text-decoration:none; cursor:pointer; font-weight:bold;">${dto.t_name}</a></td>
			                                <td><a href="adminTeacherUpdate.do?p_id=${dto.t_no}"><img src="${dto.t_img}" style="width: 20%; height: 20%;"></a></td>
			                                <td>${dto.t_course }</td>
			                                <td>${dto.t_regdate }</td>
										</tr>
									</c:forEach>
