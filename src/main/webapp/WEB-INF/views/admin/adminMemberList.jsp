        	...
        	<nav class="sb-sidenav bg-info p-2 text-dark bg-opacity-25" id="sidenavAccordion">
            	<div class="sb-sidenav-menu">
                	<div class="nav" style="text-align: center;">
                        ...
                        <a class="nav-link member" href="adminMemberList.do" style="color: #9966FF;"><div class="sb-nav-link-icon"><i class="fa fa-user" aria-hidden="true"></i></div><span>Member</span></a>
            ...
            <br>
            	<div class="container-fluid px-4">
                	...
                	<div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="adminMemberDelete.do">
                                    ...
                                    <tbody>
                                    	<c:forEach items="${memberList}" var="dto">
			                            	<tr>
			                                    ...
			                                    <td style='vertical-align:middle;'><a onclick="return goUpdate();" href="adminProductUpdate.do?p_id=${dto.user_no}" style="text-decoration:none; cursor:pointer; font-weight:bold;">${dto.user_name}</a></td>
